...
from comparison.ge.alias import create_alias_table, alias_sample
from comparison.ge.utils import preprocess_nxgraph
...
class LINE:
    def __init__(self, graph, embedding_size=8, negative_ratio=5, order='second'):
        ...
        :param order: 'first','second','all' 阶数：1阶， 2阶， 全都有
        """
